...
- View the script: <a href="../scripts/421-Build-Cosmo-Compatible-x86_64.sh" target="_blank">421-Build-Cosmo-Compatible-x86_64.sh</a>.
  - *On Github, you may need to right-click and choose "Open link in new tab" to open the "View script" links in a new tab.*
    <br/>
    <br/>
- Run the script. We run with `.` so variables can be defined and exported.
  ```
  $MMOJO_SERVER_SCRIPTS/421-Build-Cosmo-Compatible-x86_64.sh
  ```
...
- View the script: <a href="../scripts/421-Test-Cosmo-Compatible-x86_64.sh" target="_blank">421-Test-Cosmo-Compatible-x86_64.sh</a>.
- Run the script. We run with `.` so variables can be defined and exported.
  ```
  $MMOJO_SERVER_SCRIPTS/421-Test-Cosmo-Compatible-x86_64.sh
  ```
</details>
...
- View the script: <a href="../scripts/421-Copy-Cosmo-Compatible-x86_64-to-Mmojo-Share.sh" target="_blank">421-Copy-Cosmo-Compatible-x86_64-to-Mmojo-Share.sh</a>.
- Run the script:
  ```
  $MMOJO_SERVER_SCRIPTS/421-Copy-Cosmo-Compatible-x86_64-to-Mmojo-Share.sh
  ```
</details>
...
- View the script: <a href="../scripts/421-Build-Cosmo-Compatible-aarch64.sh" target="_blank">421-Build-Cosmo-Compatible-aarch64.sh</a>.
- Run the script:
  ```
  $MMOJO_SERVER_SCRIPTS/421-Build-Cosmo-Compatible-aarch64.sh
  ```
...
If your build environment is x86_64, you can test this build. Requires previously downloaded model to the `$MODELS_DIR` directory.
- View the script: <a href="../scripts/421-Test-Cosmo-Compatible-aarch64.sh" target="_blank">421-Test-Cosmo-Compatible-aarch64.sh</a>.
- Run the script:
  ```
  $MMOJO_SERVER_SCRIPTS/421-Test-Cosmo-Compatible-aarch64.sh
  ```
</details>
...
Copy this build to your Mmojo share for assembly into an APE later. This is particularly useful if you're building the x86_64 and aarch64 binaries in different build environments.
- View the script: <a href="../scripts/421-Copy-Cosmo-Compatible-aarch64-to-Mmojo-Share.sh" target="_blank">421-Copy-Cosmo-Compatible-aarch64-to-Mmojo-Share.sh</a>.
- Run the script:
  ```
  $MMOJO_SERVER_SCRIPTS/421-Copy-Cosmo-Compatible-aarch64-to-Mmojo-Share.sh
  ```
</details>
...
- View the script: <a href="../scripts/421-Assemble-Cosmo-Compatible-APE.sh" target="_blank">421-Assemble-Cosmo-Compatible-APE.sh</a>.
- Run the script:
  ```
  $MMOJO_SERVER_SCRIPTS/421-Assemble-Cosmo-Compatible-APE.sh
  ```
...
- View the script: <a href="../scripts/421-Test-Cosmo-Compatible-APE.sh" target="_blank">421-Test-Cosmo-Compatible-APE.sh</a>.
- Run the script:
  ```
  $MMOJO_SERVER_SCRIPTS/421-Test-Cosmo-Compatible-APE.sh
  ```
...
- View the script: <a href="../scripts/421-Copy-Cosmo-Compatible-APE-to-Mmojo-Share.sh" target="_blank">421-Copy-Cosmo-Compatible-APE-to-Mmojo-Share.sh</a>.
- Run the script:
  ```
  $MMOJO_SERVER_SCRIPTS/421-Copy-Cosmo-Compatible-APE-to-Mmojo-Share.sh
  ```
</details>
...
---
### Proceed
- **Next:** [422. Build APE (Performant)](422-Build-APE-Performant.md)
- **Previous:** [411. Build Debug](411-Build-Debug.md)
