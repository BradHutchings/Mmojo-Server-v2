...
- Run the script.
  ```
  $MMOJO_SERVER_SCRIPTS/410-Test-Cosmo-Build.sh X86_64 performant $TEST_WITH_CHAT_UI
  ```
</details>
...
- Run the script:
  ```
  $MMOJO_SERVER_SCRIPTS/410-Copy-Cosmo-Build-to-Mmojo-Share.sh x86_64 performant
...
- Run the script.
  ```
  $MMOJO_SERVER_SCRIPTS/410-Test-Cosmo-Build.sh aarch64 performant $TEST_WITH_CHAT_UI
  ```
</details>
...
- Run the script:
  ```
  $MMOJO_SERVER_SCRIPTS/410-Copy-Cosmo-Build-to-Mmojo-Share.sh aarch64 performant
  ```
</details>
...
- Run the script:
  ```
  $MMOJO_SERVER_SCRIPTS/410-Copy-Cosmo-APE-to-Mmojo-Share.sh performant
  ```
</details>
