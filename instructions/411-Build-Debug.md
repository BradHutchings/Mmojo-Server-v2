...
- View the script: <a href="../scripts/411-Build-Debug.sh" target="_blank">411-Build-Debug.sh</a>.
  - *On Github, you may need to right-click and choose "Open link in new tab" to open the "View script" links in a new tab.*
    <br/>
    <br/>
- Run the script. We run with `.` so variables can be defined and exported.
  ```
  $MMOJO_SERVER_SCRIPTS/411-Build-Debug.sh
  ```

---
### Test the Build - Command-Line Arguments
Requires previously downloaded model to the `$MODELS_DIR` directory.
- View the script: <a href="../scripts/411-Test-Debug-Command-Line.sh" target="_blank">411-Test-Debug-Command-Line.sh</a>.
- Run the script.
  ```
  $MMOJO_SERVER_SCRIPTS/411-Test-Debug-Command-Line.sh
  ```
...
Requires previously downloaded model to the `$MODELS_DIR` directory.
- View the script: <a href="../scripts/411-Test-Debug-mmojo-server-args.sh" target="_blank">411-Test-Debug-mmojo-server-args.sh</a>.
- Run the script.
  ```
  $MMOJO_SERVER_SCRIPTS/411-Test-Debug-mmojo-server-args.sh
  ```
</details>
...
Requires previously downloaded model to the `$MODELS_DIR` directory.
- View the script: <a href="../scripts/411-Test-Debug-mmojo-server-support.sh" target="_blank">411-Test-Debug-mmojo-server-support.sh</a>.
- Run the script.
  ```
  $MMOJO_SERVER_SCRIPTS/411-Test-Debug-mmojo-server-support.sh
  ```
</details>
...
---
### Proceed
- **Next:** [421. Build APE (Compatible)](421-Build-APE-Compatible.md)
