...
If you would like to build a vailla llama-server with a traditional chat-style interface, check out the [llama-server track](llama-server/500-Build-llama-server.md). This is the easiest way to build llama-server and other llama.cpp executables for your computer.
