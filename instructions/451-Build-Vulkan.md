...
**Shortcut:** [Scroll down](#shortcut-build-vulkan-test).
...
- View the script: <a href="../scripts/451-Build-Vulkan.sh" target="_blank">451-Build-Vulkan.sh</a>.
  - *On Github, you may need to right-click and choose "Open link in new tab" to open the "View script" links in a new tab.*
    <br/>
    <br/>
- Run the script. We run with `.` so variables can be defined and exported.
  ```
  $MMOJO_SERVER_SCRIPTS/451-Build-Vulkan.sh
  ```

---
### Test the Build
Requires previously downloaded model to the `$MODELS_DIR` directory. We test with command-line arguments.
- View the script: <a href="../scripts/451-Test-Vulkan.sh" target="_blank">451-Test-Vulkan.sh</a>.
- Run the script.
  ```
  $MMOJO_SERVER_SCRIPTS/451-Test-Vulkan.sh
  ```
...
- View the script: <a href="../scripts/451-Copy-Vulkan-Build-to-Mmojo-Share.sh" target="_blank">451-Copy-Vulkan-Build-to-Mmojo-Share.sh</a>.
- Run the script:
  ```
  $MMOJO_SERVER_SCRIPTS/451-Copy-Vulkan-Build-to-Mmojo-Share.sh
  ```
</details>

---
### SHORTCUT: Build Vulkan, Test
