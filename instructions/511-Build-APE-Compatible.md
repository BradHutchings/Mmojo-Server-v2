...
- Run the script.
  ```
  $MMOJO_SERVER_SCRIPTS/510-Test-Cosmo-Build.sh X86_64 compatible $TEST_WITH_CHAT_UI
  ```
</details>
...
- Run the script:
  ```
  $MMOJO_SERVER_SCRIPTS/510-Copy-Cosmo-Build-to-Mmojo-Share.sh x86_64 compatible
