...
- Run the script.
  ```
  $MMOJO_SERVER_SCRIPTS/620-Create-Package-Directory.sh compatible attired doghouse
...
- Run the script.
  ```
  $MMOJO_SERVER_SCRIPTS/620-Add-Certificates-to-APE.sh compatible attired doghouse
...
- Run the script.
  ```
  $MMOJO_SERVER_SCRIPTS/620-Add-UI-to-APE.sh compatible attired doghouse
  # Keep track of what we add for the args file.
...
- Run the script.
  ...
  if [ -v CHOSEN_MODEL ]; then
    $MMOJO_SERVER_SCRIPTS/620-Add-gguf-Model-to-APE.sh compatible attired doghouse
    # Keep track of what we add for the Args file.
...
- Run the script.
  ```
  $MMOJO_SERVER_SCRIPTS/620-Add-Args-to-APE.sh compatible attired doghouse
  ```
...
If you're building in WSL, your Windows web browser should be able to connect to Doghouse with the localhost links above.
...
---
### Proceed
- **Next:** [622. APE (Performant)](622-APE-Performant.md)
- **Previous:** [620. APE Packages](620-APE-Packages.md)
