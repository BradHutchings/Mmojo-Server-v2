## 522. Build Executables (Performant)
### About this Step
...
- Run the script:
  ```
  $MMOJO_SERVER_SCRIPTS/520-Copy-Executables-to-Share.sh performant $CHOSEN_GPUS
  ```
</details>
...
---
### Proceed
- **Next:** [523. Build Executables (Native)](523-Build-Executables-Native.md)
- **Previous:** [521. Build Executables (Compatible)](521-Build-Executables-Compatible.md)
