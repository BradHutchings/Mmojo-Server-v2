...
In this step, we will build Mmojo Server (`mmojo-server`) to run on the widest variety of x86_64 and aarch64 machines.
...
- View the script: <a href="../scripts/420-Build-CPU.sh" target="_blank">421-Build-CPU.sh</a>.
