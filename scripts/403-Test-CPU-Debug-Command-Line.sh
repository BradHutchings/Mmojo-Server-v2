...
TEST_DIR="$HOME/403-Test-CPU-Debug-Command-Line"
mkdir -p $TEST_DIR
rm -r -f $TEST_DIR/*
cd $TEST_DIR
...
$BUILD_LLAMA_CPP_DIR/$BUILD_CPU_DEBUG/bin/mmojo-server --model $MODELS_DIR/Google-Gemma-1B-Instruct-v3-q8_0.gguf \
...
printf "\n**********\n*\n* FINISHED: 403-Test-CPU-Debug-Command-Line.sh.\n*\n**********\n\n"
