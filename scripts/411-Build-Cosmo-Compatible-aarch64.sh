...
AARCH64_ARCH_LEVEL_PARAM=" -march=$ARCH_AARCH64_COMPATIBLE " 
...
rm -r -f $BUILD_DIR/$BUILD_COSMO_COMPATIBLE_AARCH64
cmake -B $BUILD_COSMO_COMPATIBLE_AARCH64 -DBUILD_SHARED_LIBS=OFF -DLLAMA_CURL=OFF -DLLAMA_OPENSSL=ON \
...
# Build
cmake --build $BUILD_COSMO_COMPATIBLE_AARCH64 --config Release

# Show off what we built
printf "\nBuild of Cosmo aarch64 of llama.cpp is complete.\n\n"
printf "\$ ls -al $BUILD_DIR/$BUILD_COSMO_COMPATIBLE_AARCH64/bin/\n"
ls -al $BUILD_DIR/$BUILD_COSMO_COMPATIBLE_AARCH64/bin
printf "\n"
